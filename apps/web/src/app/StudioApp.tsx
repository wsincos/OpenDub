...
export function StudioApp() {
  ...
  return (
    <main className="project-home" aria-label="OpenDub projects">
      <header className="home-topbar"><div className="home-brand"><span>OD</span> OpenDub <small>Local Studio</small></div><span>Multimodal video dubbing workspace</span></header>
