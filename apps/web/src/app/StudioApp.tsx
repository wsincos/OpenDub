...
export function StudioApp() {
  ...
  if (view === "studio" && selected) {
    return <StudioShell projectName={selected.name} onBack={() => setView("home")} />;
  }
